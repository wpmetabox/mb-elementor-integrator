...
class GroupField extends Base_Data_Control {
	...
	public function enqueue() {
		// Styles
		// wp_register_style( 'mb_group_field', plugins_url('/assets/css/mb_group_field.css', dirname(__DIR__)), [], '3.4.2' );
		// wp_enqueue_style( 'mb_group_field' );
		// wp_enqueue_style( 'select2' );
		//
		// Scripts
		// wp_register_script('mb_group_field', plugins_url('/assets/js/mb_group_field.js', dirname(__DIR__)), [], '1.0.0');
		// wp_enqueue_script('mb_group_field');
